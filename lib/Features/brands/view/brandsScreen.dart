                  ...
                  return InkWell(
                    ...
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => BrandItemsScreen(
                                  text: brands.vehicleBrand ?? "",
                                  id: brands.id ?? 0)));
                    },
                    child: FadeInDownBig(
                      child: Container(
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: FadeInImage.assetNetwork(
                                  placeholder: 'Velo.png'.ImagePath,
                                  image: brands.brandLogo ?? "",
                                  fit: BoxFit.fill,
                                  height:
                              ...
                              Text(
                                brands.vehicleBrand ?? "",
                                style:
                                    getFonts(15, Colors.black, FontWeight.bold),
                              ),
                            ],
                          ),
                        ),
