  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: getproductViewModel.isLoading
            ? Padding(
                padding: const EdgeInsets.only(top: 300),
                child: Center(child: showLoadingSpin()),
              )
            : Column(
                ...
                children: [
                  SizedBox(
                    ...
                    child: getproductViewModel.getProducts?.partImage != null
                        ? Image.network(
                            getproductViewModel.getProducts?.partImage ?? "",
                            fit: BoxFit.contain,
                          )
                  ...
                  Padding(
                    ...
                    child: RatingBar.builder(
                      ...
                      initialRating: double.parse(
                          getproductViewModel.getProducts?.productrating ??
                              "0.0"),
                      itemSize: 24,
                      minRating: 1,
                  ...
                  Padding(
                    ...
                    child: Container(
                      child: Text(
                          getproductViewModel.getProducts?.description ?? ""),
                    ),
                  ),
                ],
              ),
      ),
      bottomSheet: getproductViewModel.isLoading
          ? null
          : Container(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        if (token != null && id != null) {
                          getproductViewModel.addTocart(
                            getproductViewModel.getProducts?.id ?? 0,
                            context,
                          );
                        }
                      },
