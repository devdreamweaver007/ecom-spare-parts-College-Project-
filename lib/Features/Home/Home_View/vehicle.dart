...
class VehiclesScreen extends StatefulWidget {
  final int id;
  final String text;
  const VehiclesScreen({super.key, required this.text, required this.id});

  @override
  State<VehiclesScreen> createState() => _CategoryProductsScreenState();
}

class _CategoryProductsScreenState extends State<VehiclesScreen> {
  @override
  void initState() {
    super.initState();
