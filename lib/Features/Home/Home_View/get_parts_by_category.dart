...
class CategoryProductsScreen extends StatefulWidget {
  ...
  const CategoryProductsScreen(
      {super.key, required this.text, required this.id});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: categoryViewmodel.isLoading
            ...
            : Column(
                children: [
                  categoryViewmodel.categoryProducts.isEmpty &&
                          categoryViewmodel.isLoading == false
                      ? Padding(
                      ...
                      : Padding(
                          ...
                          child: GridView.builder(
                            ...
                            itemCount:
                                categoryViewmodel.categoryProducts.length,
                            shrinkWrap: true,
                            gridDelegate:
                            ...
                            itemBuilder: (context, index) {
                              var items =
                                  categoryViewmodel.categoryProducts[index];
                              return InkWell(
                                onTap: () {
                                  Navigator.push(
                                      context,
